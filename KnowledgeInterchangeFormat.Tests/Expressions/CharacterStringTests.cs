...
namespace KnowledgeInterchangeFormat.Tests.Expressions
{
    ...
    public class CharacterStringTests
    {
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new CharacterString(null));
        ...
        {
            var subject = new CharacterString(value);
        ...
        {
            var expected = "\"" + value.Replace("\\", "\\\\", StringComparison.Ordinal).Replace("\"", "\\\"", StringComparison.Ordinal) + "\"";
            var subject = new CharacterString(value);
