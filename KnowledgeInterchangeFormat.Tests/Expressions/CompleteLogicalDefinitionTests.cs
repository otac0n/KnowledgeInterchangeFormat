...
namespace KnowledgeInterchangeFormat.Tests.Expressions
{
    ...
    public class CompleteLogicalDefinitionTests
    {
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new CompleteLogicalDefinition(null, description, sentence));
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new CompleteLogicalDefinition(constant, description, null));
            Assert.Equal("sentence", exception.ParamName);
        }

        [Theory]
        [MemberData(nameof(ValidArguments))]
        public void Constructor_WhenGivenValidSentences_CreatesASentenceWithTheSpecifiedSentencesAndConsequents(Constant constant, CharacterString description, Sentence sentence)
        {
            var subject = new CompleteLogicalDefinition(constant, description, sentence);
