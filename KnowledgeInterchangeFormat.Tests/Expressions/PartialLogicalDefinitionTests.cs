...
namespace KnowledgeInterchangeFormat.Tests.Expressions
{
    ...
    public class PartialLogicalDefinitionTests
    {
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new PartialLogicalDefinition(null, description, sentence));
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new PartialLogicalDefinition(constant, description, null));
        ...
        {
            var subject = new PartialLogicalDefinition(constant, description, sentence);
