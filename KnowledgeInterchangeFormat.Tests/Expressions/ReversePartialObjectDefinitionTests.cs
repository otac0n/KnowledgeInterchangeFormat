...
namespace KnowledgeInterchangeFormat.Tests.Expressions
{
    ...
    public class ReversePartialObjectDefinitionTests
    {
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new ReversePartialObjectDefinition(null, description, variable, sentence));
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new ReversePartialObjectDefinition(constant, description, variable, null));
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new ReversePartialObjectDefinition(constant, description, null, sentence));
        ...
        {
            var subject = new ReversePartialObjectDefinition(constant, description, variable, sentence);
