...
namespace KnowledgeInterchangeFormat.Tests.Expressions
{
    ...
    public class UnrestrictedObjectDefinitionTests
    {
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new UnrestrictedObjectDefinition(null, null, sentences));
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new UnrestrictedObjectDefinition(constant, null, null));
        ...
        {
            var subject = new UnrestrictedObjectDefinition(constant, description, sentences);
        ...
        {
            var expected = $"(defobject {constant}{(description == null ? "" : $" {description}")}{string.Concat(sentences.Select(s => string.Concat($" {s}")))})";
            var subject = new UnrestrictedObjectDefinition(constant, description, sentences);
