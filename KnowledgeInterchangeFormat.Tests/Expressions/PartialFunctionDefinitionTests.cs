...
namespace KnowledgeInterchangeFormat.Tests.Expressions
{
    ...
    public class PartialFunctionDefinitionTests
    {
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new PartialFunctionDefinition(null, description, parameters, sequenceVariable, variable, sentence));
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new PartialFunctionDefinition(constant, description, parameters, sequenceVariable, variable, null));
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new PartialFunctionDefinition(constant, description, parameters, sequenceVariable, null, sentence));
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new PartialFunctionDefinition(constant, description, null, sequenceVariable, variable, sentence));
            Assert.Equal("parameters", exception.ParamName);
        }

        [Theory]
        [MemberData(nameof(ValidArguments))]
        public void Constructor_WhenGivenValidArguments_CreatesAnObjectWithTheSpecifiedProperties(Constant constant, CharacterString description, IndividualVariable[] parameters, SequenceVariable sequenceVariable, IndividualVariable variable, Sentence sentence)
        {
