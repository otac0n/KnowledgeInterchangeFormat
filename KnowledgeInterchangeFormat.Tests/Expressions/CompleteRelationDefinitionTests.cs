...
namespace KnowledgeInterchangeFormat.Tests.Expressions
{
    ...
    public class CompleteRelationDefinitionTests
    {
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new CompleteRelationDefinition(null, description, parameters, sequenceVariable, sentence));
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new CompleteRelationDefinition(constant, description, parameters, sequenceVariable, null));
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new CompleteRelationDefinition(constant, description, null, sequenceVariable, sentence));
        ...
        {
            var subject = new CompleteRelationDefinition(constant, description, parameters, sequenceVariable, sentence);
