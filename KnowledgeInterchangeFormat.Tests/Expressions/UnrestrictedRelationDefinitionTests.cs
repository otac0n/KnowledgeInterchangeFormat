...
namespace KnowledgeInterchangeFormat.Tests.Expressions
{
    ...
    public class UnrestrictedRelationDefinitionTests
    {
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new UnrestrictedRelationDefinition(null, null, sentences));
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new UnrestrictedRelationDefinition(constant, null, null));
        ...
        {
            var subject = new UnrestrictedRelationDefinition(constant, description, sentences);
        ...
        {
            var expected = $"(defrelation {constant}{(description == null ? "" : $" {description}")}{string.Concat(sentences.Select(s => string.Concat($" {s}")))})";
            var subject = new UnrestrictedRelationDefinition(constant, description, sentences);
