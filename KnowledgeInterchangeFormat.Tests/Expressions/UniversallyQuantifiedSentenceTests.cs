...
namespace KnowledgeInterchangeFormat.Tests.Expressions
{
    ...
    public class UniversallyQuantifiedSentenceTests
    {
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new UniversallyQuantifiedSentence(variables, null));
        ...
        {
            var exception = (ArgumentNullException)Record.Exception(() => new UniversallyQuantifiedSentence(null, quantified));
        ...
        {
            var subject = new UniversallyQuantifiedSentence(variables, quantified);
        ...
        {
            var expected = $"(forall ({string.Join(' ', variables.AsEnumerable())}) {quantified})";
            var subject = new UniversallyQuantifiedSentence(variables, quantified);
